...
namespace DI44UF_HFT_2023241.EndPoint.Controllers
{
    ...
    {
        public OrderDetailController(ILogger logger, ILogic<OrderDetail> logic, IMapper<OrderDetail, OrderDetailDto> orderDetailMapper)
                                    : base(logger, logic, orderDetailMapper)
        {
        }
    }
}
