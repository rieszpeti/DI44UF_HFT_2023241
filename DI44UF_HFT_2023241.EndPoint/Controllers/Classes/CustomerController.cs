...
namespace DI44UF_HFT_2023241.EndPoint.Controllers
{
    ...
    {
        public CustomerController(ILogger logger, ICustomerLogic customerLogic, IMapper<Customer, CustomerDto> customerMapper)
                                  : base(logger, customerLogic, customerMapper)
        {
        }
    }
}
